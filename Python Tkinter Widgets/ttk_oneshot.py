...
comon_widgets= tk.Frame(main_window,bg="#086788",borderwidth=2,relief="ridge")
comon_widgets.pack(padx=5,pady=5,fill="both")
tk.Frame()


## The Actual Widgets
button=ttk.Button(comon_widgets,text="TTK Button",)
button.grid(padx=10,pady=5,row=0, column=0)

check_button=ttk.Checkbutton(comon_widgets,text="Check Button",)
check_button.grid(padx=10,pady=5,row=0, column=1)

val= tk.StringVar()
val.set("TTK Entry")
entry=ttk.Entry(comon_widgets,textvariable=val)
entry.grid(padx=10,pady=5,row=0, column=2)

frame=ttk.Frame(comon_widgets,width=150, height=60)
frame.grid(padx=10,pady=5,row=0, column=3,sticky="ew")
# label_fframe = ttk.Label(frame, text="Label on Frame")
# label_fframe.pack()


label=ttk.Label(comon_widgets,text="TTK Label")
label.grid(padx=10,pady=5,row=1, column=0)

label_frame=ttk.LabelFrame(comon_widgets,text="TTK Label Frame",width=150, height=60)
label_frame.grid(padx=10,pady=5,row=1, column=1)

menu_button=ttk.Menubutton(comon_widgets,text="TTK Menubutton")
...
panel_window = ttk.PanedWindow(comon_widgets,orient="horizontal",width=150, height=60)
panel_window.grid(padx=10,pady=5,row=1, column=3,sticky="ew")
# label_fpanel = ttk.Label(panel_window, text="Label on Panel_Window")
# label_fpanel.pack()

radio_button=ttk.Radiobutton(comon_widgets,text="TTk Radio button",)
radio_button.grid(padx=10,pady=5,row=2, column=0)


scale=ttk.Scale(comon_widgets,from_=0,to=100,orient="horizontal")
scale.grid(padx=10,pady=5,row=2, column=1)


scrollbar=ttk.Scrollbar(comon_widgets,orient="horizontal",)
...
# sizegrip = ttk.Sizegrip(comon_widgets)
